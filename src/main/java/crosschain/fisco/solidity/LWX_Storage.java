...
public class LWX_Storage extends Contract {
    public static final String[] BINARY_ARRAY = {"6080604052348015600f57600080fd5b50603f80601d6000396000f3fe6080604052600080fdfea2646970667358221220b077e37beea7d2e8dc58a34602f7b8913c6902a409b12e2e85c5c267959e6a9564736f6c634300060a0033"};

    public static final String BINARY = org.fisco.bcos.sdk.utils.StringUtils.joinAll("", BINARY_ARRAY);

    public static final String[] SM_BINARY_ARRAY = {"6080604052348015600f57600080fd5b50603f80601d6000396000f3fe6080604052600080fdfea26469706673582212209e7903429d054b2438cd1268da7332a7b7c82dd26a1d8a5d446350c2f04553a364736f6c634300060a0033"};
    ...
    protected LWX_Storage(String contractAddress, Client client, CryptoKeyPair credential) {
    ...
    public static LWX_Storage load(String contractAddress, Client client, CryptoKeyPair credential) {
        return new LWX_Storage(contractAddress, client, credential);
    }

    public static LWX_Storage deploy(Client client, CryptoKeyPair credential) throws ContractException {
        return deploy(LWX_Storage.class, client, credential, getBinary(client.getCryptoSuite()), "");
    }
