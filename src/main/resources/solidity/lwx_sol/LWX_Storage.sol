...
//    }
    ...
    LWX_CrossChainContractAdditional internal _CrossChainContractAdditional;
    ...
    /// @member cross-chain transaction processing result: 0 ,1 ,2 ,3
    /// @member withdrawal status of cross-chain transaction assets: 0 ,1 ,2
    ...
    /// @member contract location(角色): 0 ,1 ,2
    struct _CrossTxObj {
        string CrossTxNo;
        string SrcChainCode;
        ...
        uint256  SendProofs_LedgerSeq;
        string SendProofs_TxHash;
        address SendProofs_Verifieraddr;

        uint256  AckProofs_LedgerSeq;
        string AckProofs_TxHash;
        address AckProofs_Verifieraddr;
